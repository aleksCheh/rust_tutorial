...
pub fn apply_prefab(mb: &mut CrawlerMapBuilder, rng: &mut RandomNumberGenerator) {
    ...
    while placement.is_none() || attempts < 10 {
        ...
        dimensions.for_each(|pt| {
            let mut idx = mb.map.point2d_to_index(pt);
            ...
            if can_place {
                ...
                let d = dimensions.point_set();
                mb.monster_spawn.retain(|p| !d.contains(p));
            }
            attempts += 1;
        });
    }
